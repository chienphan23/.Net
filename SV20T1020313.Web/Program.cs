...
using SV20T1020313.Web;

var builder = WebApplication.CreateBuilder(args);

// Add services to the container. // add các services cần dùng trong ứng dụng
...
// kh?i t?o businesslayers tr??c khi ch?y ?ng d?ng
string connectionString = "server=.;user id=sa;password=123;database=LiteCommerceDB;TrustServerCertificate=true";
SV20T1020313.BusinessLayers.Configuration.Initiallize(connectionString);
