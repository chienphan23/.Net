...
namespace SV20T1020313.Web.Controllers
{
    ...
    public class OrderController : Controller
    {
        ...
        /// Hàm trả về chuỗi khác rỗng và thông báo lỗi nếu đầu vào không hợp lệ hoặc lỗi.
        ...
        public IActionResult UpdateDelivery(int orderID = 0, string deliveryAddress = "", string deliveryProvince = "")
        {
            if (string.IsNullOrWhiteSpace(deliveryAddress))
                ModelState.AddModelError("deliveryAddress", "Địa chỉ chuyển hàng không được để trống");
            if (string.IsNullOrWhiteSpace(deliveryAddress))
            ...
            bool result = OrderDataService.UpdateDeliveryOrder(orderID, deliveryAddress, deliveryProvince);
            if (!result)
            {
                TempData["Message"] = "Không thể duyệt đơn hàng này";
            }
